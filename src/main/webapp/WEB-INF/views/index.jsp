...
<head>
	...
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/bootstrap/fonts/linearicons-v1.0.0/icon-font.min.css">
	<!--===============================================================================================-->
	...
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/bootstrap/vendor/slick/slick.css">
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/bootstrap/vendor/MagnificPopup/magnific-popup.css">
	<!--===============================================================================================-->
			...
			<div class="wrap-menu-desktop">
				...
				<nav class="limiter-menu-desktop p-l-45">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li>
								...
								<ul class="sub-menu">
									<li><a href="index.html">스킨케어</a>
										<ul class="sub-menu">
											<li><a href="index.html">스킨케어 1</a></li>
											<li><a href="home-02.html">스킨케어 2</a></li>
											<li><a href="home-03.html">스킨케어 3</a></li>
										</ul>
									</li>
									<li><a href="home-02.html">바디케어</a>
										<ul class="sub-menu">
											<li><a href="index.html">바디케어 1</a></li>
											<li><a href="home-02.html">바디케어 2</a></li>
											<li><a href="home-03.html">바디케어 3</a></li>
										</ul>
									</li>
									<li><a href="home-03.html">헤어케어</a>
										<ul class="sub-menu">
											<li><a href="index.html">헤어케어 1</a></li>
											<li><a href="home-02.html">헤어케어 2</a></li>
											<li><a href="home-03.html">헤어케어 3</a></li>
										</ul>
									</li>
								</ul>
							</li>
							...
							<li>
								<a href="shoping-cart.html">장바구니(임시)</a>
							</li>
					...
					<div class="wrap-icon-header flex-w flex-r-m h-full">
						<!-- 장바구니 아이콘 (data-notify에 현재 장바구니에 담긴갯수 표시하기) -->
		...
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-05.jpg);"
					data-thumb="images/thumb-01.jpg" data-caption="커서or해당사진선택중">
		...
		<div class="flex-w flex-c-m">
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					<img src="images/a.jpg" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="tab01">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item p-b-10 label1" data-label1="hot" style="height: 50px; justify-content:end">
						<a class="nav-link active" data-toggle="tab" href="#best-seller" role="tab">베스트 상품</a>
					</li>

					<li class="nav-item p-b-10">
						<a class="nav-link" data-toggle="tab" href="#featured" role="tab">추천 상품</a>
					</li>

					<li class="nav-item p-b-10">
						<a class="nav-link" data-toggle="tab" href="#sale" role="tab">신규 상품</a>
					</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<pre class="stext-107 cl7 size-201">대표이사 : 이선정<br>사업자등록번호 : 809-81-01574<br>주소 : (04323) 서울특별시 용산구 한강대로<br> 372, 24층(동자동, KDB타워)<br>호스팅사업자 : CJ 올리브네트웍스<br>통신판매업신고번호 : 2019-서울용산-1428<br>이메일 : oliveweb@cj.net</pre>
