...
<body class="animsition">
	...
	<br>
		...
		<button style="width: 180px" class="stext-101 cl0 size-116 bg11 bor14 hov-btn4 p-lr-15 trans-04 pointer">주문상세 보기</button>
		<button style="width: 180px" class="stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">쇼핑 계속하기</button>
	</div>
