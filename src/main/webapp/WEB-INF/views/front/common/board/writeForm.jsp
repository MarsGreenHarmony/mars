	...
	<div id="Container">
		...
		<div id="Contents">
			...
			<div class="mypage-head rate_05">
				<h1 class="tit">
					<a href="/front/customer/myPage">고객센터</a>
				</h1>
			...
			<div class="mypage-ix">
				...
				<div class="mypage-lnb">
					<ul>
						<li><h2>고객 센터</h2>
							<ul>
								<li class="subMenu on"><a href="/front/buy/orderList">공지사항</a></li>
								<li class="subMenu"><a href="javascript:;">자주찾는 질문</a></li>
								<li class="subMenu"><a href="javascript:;">고객문의</a></li>
							</ul>
				</div>
						...
						<c:forEach items="${list}" var="item">
							<tr>
								...
								<td style="text-align: left">
									<%-- <a href="/backoffice/board/noticeview?seq_sel=${list.seq_sel}">${item.contents}</a> --%>
								</td>
								<td>${item.register}</td>
								<td>${item.dt_reg}</td>
							</tr>
