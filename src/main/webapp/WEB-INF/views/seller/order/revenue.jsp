  ...
  <head>
    ...
    $(function() {
    	  ...
    	  var data = {
    	    ...
    	    datasets: [{
    	      label: '매출',
    	      data: [6345200, 2354100,4758960, 4125700, 7245100, 3357100, 4215300,8124500,10124750,2421300,5412500,2453100],
    	      backgroundColor: [
    	        'rgba(255, 99, 132, 0.2)',
    	        'rgba(54, 162, 235, 0.2)',
    	        'rgba(255, 206, 86, 0.2)',
     ...
     <%@ include file="/WEB-INF/views/include/seller/header.jsp" %>
        ...
        <div class="main-panel">
          ...
          <div class="">
                    ...
                    <h4 class="card-title">월별매출</h4>
                    <canvas id="barChart" style="height: 205px; display: block; width: 410px;" width="410" height="205" class="chartjs-render-monitor"></canvas>
                  </div>
