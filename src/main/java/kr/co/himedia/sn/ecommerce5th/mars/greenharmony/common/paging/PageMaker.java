...
public class PageMaker {
	...
	public String searchQuery(int currPage) {
		...
		UriComponents uriComponents = UriComponentsBuilder.newInstance().queryParam("currPage", currPage)
				...
				.queryParam("keyword", cri.getKeyword()).queryParam("keyword2", cri.getKeyword2()).queryParams(checkMap)
				.build();
		return uriComponents.toString();
	} // searchQuery
	...
	public String toString() {
		return "PageMaker [getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString()
				+ "]";
	}
